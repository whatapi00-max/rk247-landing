      ...
      <div class="mt-10 grid gap-4 lg:grid-cols-2">
        ...
        <article class="reveal card lg:col-span-2 flex items-center justify-between gap-4 p-6 sm:p-8">
          <div class="max-w-xs">
            ...
            <a href="https://fx777crm.theplatformapi.com/auth-pages/create-account/step1?accountType=demo" target="_blank" rel="noopener noreferrer" class="btn-green mt-4">Try now</a>
            ${learn("#features")}
          </div>
