    ...
    <div class="container-rk">
      ...
      <div class="mt-10 grid gap-4 sm:grid-cols-2">
        ...
        <article class="reveal card relative min-h-[260px] overflow-hidden p-6 sm:p-8">
          ...
          <a href="https://fx777crm.theplatformapi.com/auth-pages/create-account/step1?accountType=real" target="_blank" rel="noopener noreferrer" class="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-rk-green hover:text-rk-greenBright">Try for free ${icons.chevronRight}</a>
        ...
        <article class="reveal card min-h-[260px] p-6 sm:p-8">
          ...
          <a href="/help/learning" class="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-rk-green hover:text-rk-greenBright">Start learning ${icons.chevronRight}</a>
